...
Future<void> initDependencies() async {
  ...
  // sl.registerSingleton(() => SystemSettingsRepo());
  // sl.registerSingleton(() => ProfileRepo());
  // sl.registerSingleton(() => WithdrawalRepo());
  // sl.registerSingleton(() => EarningsRepo());
  // sl.registerSingleton(() => CashCollectionRepo());
  // sl.registerSingleton(() => RatingsRepo());
  // sl.registerSingleton(() => NotificationListRepo());
  // BLoCs
