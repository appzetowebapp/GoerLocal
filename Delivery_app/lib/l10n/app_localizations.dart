...
abstract class AppLocalizations {
  ...
  /// No description provided for @locationDataUsageDisclosure.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @locationUsageDescription.
  ///
  /// In en, this message translates to:
  /// **'collects location data to enable accurate order delivery, real-time status updates for customers, and distance tracking for sellers even when the app is closed or not in use. This data is used to provide timely service and calculate your delivery payouts based on distance traveled'**
  ...
  /// No description provided for @locationMandateTitle.
  ///
  /// In en, this message translates to:
  /// **'Real-time location is mandatory to receive orders and track deliveries. The app cannot function without this permission.'**
  ...
  /// No description provided for @mobileNoInUse.
  ///
  /// In en, this message translates to:
  /// **'Mobile already registered'**
  String get mobileNoInUse;
