...
class AppLocalizationsHi extends AppLocalizations {
  ...
  @override
  String get locationDataUsageDisclosure => 'स्थान डेटा उपयोग प्रकटीकरण';

  @override
  String get referAndEarnTitle => 'अपने दोस्तों को रेफर करें और इनाम कमाएं';

  @override
  String get referAndEarnDescription =>
      'अपने रेफरल कोड का उपयोग करके दोस्तों को आमंत्रित करें और जब वे साइन अप करके अपनी पहली ऑर्डर करें तो इनाम पाएं';

  @override
  String get locationUsageDescription =>
      'यह ऐप सटीक ऑर्डर डिलीवरी, ग्राहकों के लिए रीयल-टाइम ऑर्डर स्टेटस अपडेट और विक्रेताओं के लिए दूरी ट्रैकिंग को सक्षम करने के लिए लोकेशन डेटा एकत्र करता है, तब भी जब ऐप बंद हो या उपयोग में न हो। इस डेटा का उपयोग समय पर सेवा प्रदान करने और तय की गई दूरी के आधार पर आपके डिलीवरी भुगतान की गणना करने के लिए किया जाता है।';
  ...
  String get locationMandateTitle =>
      'ऑर्डर प्राप्त करने और डिलीवरी ट्रैक करने के लिए रियल-टाइम लोकेशन अनिवार्य है। इस अनुमति के बिना ऐप काम नहीं कर सकता।';

  @override
  String get share => 'शेयर करें';

  @override
  String get youEarn => 'आप कमाते हैं';
  ...
  @override
  String get shareYourCode => 'अपना कोड शेयर करें';

  @override
  String get sendYourReferralCodeOrAppLinkToFriends =>
      'अपने रेफरल कोड या ऐप लिंक दोस्तों को भेजें।';

  @override
  String get theyRegisterUsingYourReferralCode =>
      'वे आपके रेफरल कोड का उपयोग करके रजिस्टर करते हैं।';

  @override
  String get whenTheyCompleteTheirFirstOrderYouEarn =>
      'जब वे अपनी पहली ऑर्डर पूरी करते हैं, तब आप कमाते हैं';
  ...
  @override
  String get enterrefercode => 'अपना रेफरल कोड दर्ज करें';
  ...
  String get deleteAccountDesc =>
      'क्या आप वाकई अपना खाता स्थायी रूप से हटाना चाहते हैं? यह कार्रवाई वापस नहीं ली जा सकती।';

  @override
  String get mobileNoInUse => 'Mobile already registered';

  @override
  String get viewTransactions => 'ટलेनदेन देखें';
  ...
  @override
  String get accountNotVerified => 'आपका खाता अभी तक सत्यापित नहीं हुआ है';
}
