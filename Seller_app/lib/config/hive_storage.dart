...
class HiveStorage {
  ...
  static Future<void> initPrefs() async {
    try {
      ...
      _registeredIdentifier = prefBox.get(_registeredIdentifierKey) as String?;
  ...
  static const String _registeredIdentifierKey = "registeredIdentifier";
  static String? _registeredIdentifier;
  ...
  static String? get registeredIdentifier => _registeredIdentifier;

  static Future<void> setRegisteredIdentifier(String? value) async {
    final Box prefBox = await Hive.openBox(_prefBoxName);
    if (value == null) {
      await prefBox.delete(_registeredIdentifierKey);
    } else {
      await prefBox.put(_registeredIdentifierKey, value);
    }
    _registeredIdentifier = value;
    debugPrint('Set RegisteredIdentifier :: $_registeredIdentifier');
  }
