...
import 'package:hyper_local_seller/screen/products_page/add_ons/addon_groups/cubit/addon_groups_cubit.dart';
import 'package:hyper_local_seller/screen/products_page/add_ons/addon_groups/repo/addon_groups_repo.dart';
import 'package:hyper_local_seller/screen/products_page/product_addons/product_addons_group/cubit/product_addon_cubit.dart';
import 'package:hyper_local_seller/screen/products_page/product_addons/product_addons_group/repo/product_addon_repo.dart';

import 'package:hyper_local_seller/screen/more_page/view/store_addon_inventory/store_addon_list/cubit/store_addon_inventory_cubit.dart';
import 'package:hyper_local_seller/screen/more_page/view/store_addon_inventory/store_addon_list/repo/store_addon_inventory_repo.dart';
...
import 'package:hyper_local_seller/utils/app_update/bloc/app_update_bloc.dart';
  ...
  runApp(
    MultiRepositoryProvider(
      providers: [
        ...
        RepositoryProvider(create: (_) => AddonGroupsRepo()),
        RepositoryProvider(create: (_) => ProductAddonRepo()),
        RepositoryProvider(create: (_) => StoreAddonInventoryRepo()),
      ],
      child: MultiBlocProvider(
        providers: [
          BlocProvider(create: (_) => AppUpdateBloc()),
          BlocProvider(create: (_) => SettingsCubit()),
          BlocProvider(create: (_) => ConnectivityCubit()),
          BlocProvider(create: (_) => ScreenSizeBloc()),
          BlocProvider(create: (_) => LanguageCubit()),
          BlocProvider(create: (_) => ThemeCubit()),
          BlocProvider(create: (context) => AuthBloc(context.read<AuthRepository>(), FirebasePhoneAuthService())),
          BlocProvider(create: (context) => ForgotPasswordBloc(context.read<AuthRepository>())),
          BlocProvider(create: (context) => VerifyUserBloc(authRepository: context.read<AuthRepository>())),
          BlocProvider(create: (context) => BrandsBloc(context.read<BrandsRepo>())),
          BlocProvider(create: (context) => CategoriesBloc(context.read<CategoriesRepo>())),
          BlocProvider(create: (context) => AttributesBloc(context.read<AttributesRepo>())),
          BlocProvider(create: (context) => AttributeValuesBloc(context.read<AttributesRepo>())),
          BlocProvider(create: (context) => ProductsBloc(context.read<ProductsRepo>())),
          BlocProvider(create: (context) => TaxGroupsBloc(context.read<TaxGroupsRepo>())),
          BlocProvider(create: (context) => StoresBloc(context.read<StoresRepo>())),
          BlocProvider(create: (context) => StoreSwitcherCubit(context.read<StoresRepo>())),
          ...
          BlocProvider(create: (context) => AddStoreBloc(context.read<AddStoreRepository>())),
          BlocProvider(create: (context) => HomePageBloc(repo: context.read<HomeDataRepo>())..add(FetchHomePageData())),
          BlocProvider(create: (context) => OrdersBloc(context.read<OrdersRepo>())..add(LoadOrdersInitial())),
          BlocProvider(create: (context) => OrderFiltersBloc(context.read<OrdersRepo>())..add(FetchOrderFilters())),
          BlocProvider(create: (context) => OrderDetailsBloc(context.read<OrdersRepo>())),
          BlocProvider(create: (context) => ProfileBloc()),
          BlocProvider(create: (context) => WalletBloc()),
          BlocProvider(create: (context) => WithdrawHistoryBloc(WalletRepository())),
          BlocProvider(create: (context) => TransactionsHistoryBloc(WalletRepository())),
          BlocProvider(create: (context) => SettledEarningsBloc(EarningRepository())),
          BlocProvider(create: (context) => UnsettledEarningsBloc(EarningRepository())),
          BlocProvider(create: (context) => ProductFaqBloc(context.read<ProductFaqRepo>())),
          BlocProvider(create: (context) => RolesBloc(RolesRepo())),
          BlocProvider(create: (context) => DeliveryZoneBloc(context.read<DeliveryZoneRepo>())),
          BlocProvider(create: (context) => SystemUserBloc(repo: SystemUsersRepo())),
          BlocProvider(
            create: (context) => NotificationListBloc(context.read<NotificationListRepo>())..add(FetchUnreadCount()),
          ),
          BlocProvider(
            create: (context) =>
                SubscriptionPlanBloc(context.read<SubscriptionPlansRepo>())..add(LoadSubscriptionPlansInitial()),
          ),
          BlocProvider(create: (context) => CheckEligibilityBloc(context.read<SubscriptionPlansRepo>())),
          BlocProvider(create: (context) => CurrentSubscriptionBloc(context.read<SubscriptionPlansRepo>())),
          BlocProvider(create: (context) => BuySubscriptionBloc(context.read<SubscriptionPlansRepo>())),
          BlocProvider(create: (_) => SubscriptionHistoryBloc(SubscriptionHistoryRepo())),
          BlocProvider(create: (context) => AddonGroupsCubit(context.read<AddonGroupsRepo>())),
          BlocProvider(create: (context) => ProductAddonCubit(context.read<ProductAddonRepo>())),
          BlocProvider(create: (context) => StoreAddonInventoryCubit()),
        ],
      ...
      builder: (context, connectivityState) {
        return BlocBuilder<SettingsCubit, SettingsState>(
          builder: (context, settingsState) {
            ...
            if (settingsState is SettingsLoaded && settingsState.maintenanceMode) {
              // Show maintenance screen with MaterialApp wrapper for theming
              return _buildMaterialWrapper(context, const MaintenanceScreenWrapper());
            }
...
class MaintenanceScreenWrapper extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final message = settingsState is SettingsLoaded ? settingsState.maintenanceMessage : null;
...
class AppLifecycleObserverWidget extends StatefulWidget {
  ...
  @override
  State<AppLifecycleObserverWidget> createState() => _AppLifecycleObserverWidgetState();
}

class _AppLifecycleObserverWidgetState extends State<AppLifecycleObserverWidget> with WidgetsBindingObserver {
  @override
  void initState() {
    super.initState();
  ...
  Future<void> _checkAndRefreshIfNeeded() async {
    try {
      ...
      final needsOrderRefresh = box.get('pendingOrderRefresh', defaultValue: false) as bool;
      final needsCountRefresh = box.get('pendingNotificationCountRefresh', defaultValue: false) as bool;
      ...
      if (needsOrderRefresh) {
        ...
        debugPrint('[Lifecycle] Resumed — dispatching RefreshOrders from pending bg notification');
      }
      if (needsCountRefresh) {
        context.read<NotificationListBloc>().add(FetchUnreadCount());
        debugPrint('[Lifecycle] Resumed — dispatching FetchUnreadCount from pending bg notification');
      }
    } catch (e) {
