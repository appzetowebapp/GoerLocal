      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              value,
              style: TextStyle(fontSize: UIUtils.appTitle(screenType), fontWeight: UIUtils.bold),
            ),
            SizedBox(height: UIUtils.gapXS(screenType)),
            Text(
              trend,
              style: TextStyle(fontSize: UIUtils.caption(screenType), fontWeight: UIUtils.semiBold, color: trendColor),
            ),
          ],
        ),
      ),
