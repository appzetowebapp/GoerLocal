...
class _MorePageState extends State<MorePage> {
      ...
      SettingsSectionData(
        ...
        tiles: [
              ...
              CustomSelectionSheet.show<ThemeMode>(
                ...
                items: [
                  SelectionItem(
                    ...
                    sublabel: l10n?.systemMessage ?? 'Matches your device settings',
                  ...
                  SelectionItem(
                    ...
                    sublabel: l10n?.darkMessage ?? 'Gentle on eyes in low light',
          ...
          SettingsTileData(
            ...
            subtitle: l10n?.selectYourPreferredLanguage ?? "Select your preferred language",
            onTap: () {
              CustomSelectionSheet.show<String>(
                ...
                items: [
                  SelectionItem(label: 'English', sublabel: 'English', value: 'en', leadingText: 'EN'),
                  SelectionItem(label: 'Hindi', sublabel: 'हिंदी', value: 'hi', leadingText: 'HI'),
                  SelectionItem(label: 'Arabic', sublabel: 'العربية', value: 'ar', leadingText: 'AR'),
                ],
      ...
      SettingsSectionData(
        ...
        tiles: [
          SettingsTileData(
            ...
            subtitle: l10n?.manageProductSubtitle ?? "Add, edit, and organize products",
            onTap: () {
              if (!PermissionChecker.hasPermission(AppPermissions.productView)) {
                showCustomSnackbar(
                  context: context,
                  message: l10n?.noPermissionViewProducts ?? 'You do not have permission to view products.',
                  isWarning: true,
                );
                return;
              }
              ...
              _showBrandSelection(context, screenType);
              // context.pushNamed(AppRoutes.productsFull);
            },
          ),

          SettingsTileData(
            img: ImagesPath.inventory,
            title: "Store Add on Inventory",
            subtitle: "Add, edit, and organize Store Add on inventory",
            onTap: () {
              if (!PermissionChecker.hasPermission(AppPermissions.productView)) {
                showCustomSnackbar(
                  context: context,
              ...
              context.pushNamed(AppRoutes.storeAddonInventory);
            },
          ),
          ...
          SettingsTileData(
            ...
            subtitle: l10n?.ordersSubtitle ?? "Manage and track customer orders",
            onTap: () {
              if (!PermissionChecker.hasPermission(AppPermissions.orderView)) {
                showCustomSnackbar(
                  context: context,
                  message: l10n?.noPermissionViewOrders ?? 'You do not have permission to view orders.',
                  isWarning: true,
                );
                return;
              }
          ...
          SettingsTileData(
            ...
            onTap: () {
              if (!PermissionChecker.hasPermission(AppPermissions.storeView)) {
                showCustomSnackbar(
                  context: context,
                  message: l10n?.noPermissionViewStores ?? 'You do not have permission to view stores.',
                  isWarning: true,
                );
                return;
              }
          ...
          SettingsTileData(
            ...
            onTap: () {
              if (!PermissionChecker.hasPermission(AppPermissions.categoryView)) {
                showCustomSnackbar(
                  context: context,
                  message: l10n?.noPermissionViewCategories ?? 'You do not have permission to view categories.',
                  isWarning: true,
                );
                return;
              }
          ...
          SettingsTileData(
            ...
            onTap: () {
              if (!PermissionChecker.hasPermission(AppPermissions.brandView)) {
                showCustomSnackbar(
                  context: context,
                  message: l10n?.noPermissionViewBrands ?? 'You do not have permission to view brands.',
                  isWarning: true,
                );
                return;
              }
          ...
          SettingsTileData(
            ...
            onTap: () {
              if (!PermissionChecker.hasPermission(AppPermissions.attributeView)) {
                showCustomSnackbar(
                  context: context,
                  message: l10n?.noPermissionViewAttributes ?? 'You do not have permission to view attributes.',
                  isWarning: true,
                );
                return;
              }
          ...
          SettingsTileData(
            ...
            subtitle: l10n?.productFaqSubtitle ?? 'Manage your product questions & answers',
            onTap: () {
              if (!PermissionChecker.hasPermission(AppPermissions.productFaqView)) {
                showCustomSnackbar(
                  context: context,
                  message: l10n?.noPermissionViewProductFAQs ?? 'You do not have permission to view product FAQs.',
                  isWarning: true,
                );
                return;
              }
      ...
      SettingsSectionData(
        ...
        tiles: [
          SettingsTileData(
            ...
            subtitle: l10n?.walletSubtitle ?? "Seller's wallet balance & transactions",
            onTap: () {
              if (!PermissionChecker.hasPermission(AppPermissions.walletView)) {
                showCustomSnackbar(
                  context: context,
                  message: l10n?.noPermissionViewWallet ?? 'You do not have permission to view your wallet.',
                  isWarning: true,
                );
                return;
              }
          ...
          SettingsTileData(
            ...
            subtitle: l10n?.earningsSubtitle ?? "View commissions & settlements",
            onTap: () {
              if (!PermissionChecker.hasPermission(AppPermissions.earningView)) {
                showCustomSnackbar(
                  context: context,
                  message: l10n?.noPermissionViewEarnings ?? 'You do not have permission to view earnings.',
                  isWarning: true,
                );
                return;
              }
          ...
          SettingsTileData(
            ...
            onTap: () {
              if (!PermissionChecker.hasPermission(AppPermissions.taxRateView)) {
                showCustomSnackbar(
                  context: context,
                  message: l10n?.noPermissionViewTaxRates ?? 'You do not have permission to view tax rates.',
                  isWarning: true,
                );
                return;
              }
          ...
          if (HiveStorage.isSubscriptionAvailable) ...[
            SettingsTileData(
              ...
              onTap: () {
                if (!PermissionChecker.hasPermission(AppPermissions.subscriptionView)) {
                  showCustomSnackbar(
                    context: context,
                    message:
      ...
      SettingsSectionData(
        ...
        tiles: [
          ...
          SettingsTileData(
            ...
            subtitle: l10n?.readTermsAndConditions ?? 'Read our terms and conditions',
            onTap: () {
      ...
      SettingsSectionData(
        ...
        tiles: [
          SettingsTileData(
            ...
            subtitle: l10n?.rolesAndPermissionsSubtitle ?? "User access control",
            onTap: () {
          ...
          SettingsTileData(
            ...
            onTap: () {
              if (!PermissionChecker.hasPermission(AppPermissions.systemUserView)) {
                showCustomSnackbar(
                  context: context,
          ...
          SettingsTileData(
            ...
            onTap: () {
              showAppAlertDialog(
                ...
                message: l10n?.logoutConfirmationMessage ?? "Are you sure you want to log out from your account?",
          ...
          SettingsTileData(
            img: ImagesPath.deleteAccountSvg,
            ...
            onTap: () {
              showAppAlertDialog(
                ...
                confirmText: l10n?.deleteConfirmation ?? "Yes, Delete",
                cancelText: l10n?.logoutCancelButton ?? "Cancel",
                isDestructive: true,
                onConfirm: () {
                  // Clear ALL BLoC data FIRST while context is still valid
                  MasterApiService.clearAllApisData(context);
                  // Then trigger the actual logout (clears token & Hive)
                  context.read<AuthBloc>().add(AuthDeletedRequested());
                },
                onCancel: () {
  ...
  Widget build(BuildContext context) {
    ...
    final bgColor = isDark ? theme.colorScheme.surface : theme.colorScheme.surfaceContainer;
      ...
      body: BlocListener<AuthBloc, AuthState>(
        listener: (context, state) {
          if (state is AuthInitial) {
            showCustomSnackbar(context: context, message: l10n?.logoutMessage ?? 'Logout successful');
            context.go('/login');
          ...
          child: Column(
            ...
            children: [
              ..._getSections(context).map((section) {
                ...
                return SettingsSection(sectionTitle: section.title, tiles: section.tiles);
              }),
        ...
        child: Padding(
          ...
          child: BlocBuilder<ProfileBloc, ProfileState>(
            builder: (context, state) {
              ...
              if (state is ProfileLoaded && state.profile.data != null) {
              ...
              } else if (state is ProfileUpdateSuccess && state.updatedProfile.data != null) {
                ...
                profileImage = state.updatedProfile.data!.profileImage ?? profileImage;
              } else if (state is ProfileUpdating && state.currentProfile?.data != null) {
                ...
                profileImage = state.currentProfile!.data!.profileImage ?? profileImage;
              }
                ...
                children: [
                  Container(
                    ...
                    child: CustomNetworkImage(
                      ...
                      isCircle: true,
                      fit: BoxFit.cover,
                      errorWidget: Icon(Icons.person, size: UIUtils.profileIconSize(screenType), color: Colors.grey),
                    ),
                  ),
  ...
  void _showBrandSelection(BuildContext context, screenType) {
    showModalBottomSheet(
      context: context,
      isScrollControlled: true,
      backgroundColor: Colors.transparent,
      builder: (context) => _buildManageProductBottomSheet(context, screenType),
    );
  }

  List<SettingsTileData> _getManageProductList(BuildContext context) {
    final l10n = AppLocalizations.of(context);

    return [
      SettingsTileData(
        isMoreMenuItemColor: true,
        img: ImagesPath.addIconSvg,
        title: l10n?.manageProduct ?? "Manage Product",
        // subtitle: l10n?.manageProductSubtitle ?? "Add, edit, and organize products",
        onTap: () {
          context.pushNamed(AppRoutes.productsFull);
      ...
      SettingsTileData(
        ...
        // subtitle: l10n?.manageProductSubtitle ?? "Add, edit, and organize products",
        onTap: () {
          context.pushNamed(AppRoutes.addOnGroup);
        },
      ),
      SettingsTileData(
        isMoreMenuItemColor: true,
        img: ImagesPath.addIconSvg,
        title: l10n?.productAdsON ?? "Products Add-ons",
        // subtitle: l10n?.manageProductSubtitle ?? "Add, edit, and organize products",
        onTap: () {
          context.pushNamed(AppRoutes.productAddOn);
        },
      ),
    ];
  }

  Widget _buildManageProductBottomSheet(BuildContext context, screenType) {
    return Container(
      decoration: BoxDecoration(
        color: Theme.of(context).cardColor,
        borderRadius: BorderRadius.vertical(top: Radius.circular(UIUtils.radiusLG(screenType))),
      ),
      child: Column(
        mainAxisSize: MainAxisSize.min,
        children: [
          ..._getManageProductList(context).map((section) {
            return SettingsTile(
              isMoreMenuItemColor: section.isMoreMenuItemColor,
              color: section.color,
              img: section.img,
              title: section.title,
