...
class BuySubscriptionCashfreePending extends BuySubscriptionState {
  final String orderId;
  final String paymentSessionId;
  final String environment;

  const BuySubscriptionCashfreePending({
  ...
  @override
  List<Object?> get props => [orderId, paymentSessionId, environment];
}
