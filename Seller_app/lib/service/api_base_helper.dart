...
enum ApiStatus { initial, loading, success, failure, loadingMore }
      ...
      if (data is Map<String, dynamic>) {
        ...
        if (data.containsKey('message')) {
          ...
          if (data.containsKey('data') && data['data'] is Map) {
            ...
            if (dataMap['verification_status'] == 'not_approved' || dataMap['pending_approval'] == true) {
              message = 'not_approved: $message';
            }
          }
          return Exception(message); // Return backend message
        }
      }
