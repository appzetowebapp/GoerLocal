...
class CardShimmer extends StatelessWidget {
  ...
  Widget _buildShimmerBody() {
    switch (type) {
      ...
      case 'addons':
        return _buildAddonsShimmer();
      default:
        return _buildRowShimmer();
    }
  }

  Widget _buildAddonsShimmer() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        // Title
          ...
          children: [
            SizedBox(
              ...
              child: Align(
                ...
                child: CustomShimmer(width: 80, height: UIUtils.body(screenType))
              )
            ),
            CustomShimmer(width: 40, height: 24, borderRadius: BorderRadius.circular(4)),
          ],
        ),
        ...
        Row(
          children: [
            SizedBox(
              ...
              child: Align(
                alignment: Alignment.centerLeft,
                child: CustomShimmer(width: 60, height: UIUtils.body(screenType))
              )
            ),
            CustomShimmer(width: 60, height: 24, borderRadius: BorderRadius.circular(4)),
          ],
        ),
        SizedBox(height: UIUtils.gapMD(screenType)),
        // Selection Type
        Row(
          children: [
            SizedBox(
              ...
              child: Align(
                alignment: Alignment.centerLeft,
                child: CustomShimmer(width: 100, height: UIUtils.body(screenType))
              )
            ),
            CustomShimmer(width: 70, height: 24, borderRadius: BorderRadius.circular(4)),
          ],
        ),
