      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(
              title,
              style: TextStyle(fontSize: UIUtils.pageTitle(screenType), fontWeight: FontWeight.bold),
            ),
          ),
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(UIUtils.radiusMD(screenType)),
                          border: Border.all(
                            color: isSelected ? AppColors.primaryColor.withValues(alpha: 0.2) : Colors.transparent,
                          ),
                        ),
                        child: Row(
                          children: [
                            ...
                            if (item.isDisabled) Icon(Icons.check_circle_rounded, color: Colors.grey, size: 20),
                            if (isSelected) Icon(Icons.check_circle_rounded, color: AppColors.primaryColor, size: 22),
                          ],
                        ),
                      ),
                    ),
