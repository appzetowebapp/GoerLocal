...
class ApiRoutes {
  ...
  static String cashfreeCreateOrderApi = '${AppConstant.baseUrl}cashfree/create-order';
  ...
  static String randomProductsApi = '${AppConstant.baseUrl}products/random-categories';
}
