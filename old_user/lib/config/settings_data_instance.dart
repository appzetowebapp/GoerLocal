...
class SettingsData {
  ...
  void setSettingsData(List<SettingsApiModel> data) {
    ...
    print('Privacy Policy: ${web?.privacyPolicy}');
    print('Refund Policy: ${web?.returnRefundPolicy}');
    print('Shipping Policy: ${web?.shippingPolicy}');
    print('Terms & Conditions: ${web?.termsCondition}');
  }
