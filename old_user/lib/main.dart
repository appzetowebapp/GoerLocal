  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(create: (context) => HomeDeliveryBloc()),
        ...
        BlocProvider(create: (context) => PreviouslyBoughtBloc()),
      ],
              ...
              builder: (context, languageState) {
                return GestureDetector(
                  ...
                  child: ScreenUtilInit(
                    designSize: const Size(375, 812), // Standard iPhone 13/14 size as base
                    minTextAdapt: true,
