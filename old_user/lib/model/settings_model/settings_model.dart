...
class SystemSettings {
  ...
  factory SystemSettings.fromJson(Map<String, dynamic> json) {
    return SystemSettings(
      ...
      minimumCartAmount: (json['minimumCartAmount'] as num).toInt(),
      maximumItemsAllowedInCart: (json['maximumItemsAllowedInCart'] as num).toInt(),
      ...
      welcomeWalletBalanceAmount: (json['welcomeWalletBalanceAmount'] as num).toInt(),
...
class PaymentSettings {
  ...
  final bool cashfreePayment;
  final String cashfreePaymentMode;
  ...
  PaymentSettings({
    ...
    required this.cashfreePaymentMode,
  ...
  factory PaymentSettings.fromJson(Map<String, dynamic> json) {
    return PaymentSettings(
      ...
      cashfreePayment: json['cashfreePayment'] as bool? ?? false,
      cashfreePaymentMode: json['cashfreePaymentMode'] as String? ?? 'test',
      cashfreeAppId: json['cashfreeAppId'] as String? ?? '',
...
class WebSettings {
  ...
  factory WebSettings.fromJson(Map<String, dynamic> json) {
    return WebSettings(
      ...
      defaultLatitude: json['defaultLatitude']?.toString() ?? '',
      defaultLongitude: json['defaultLongitude']?.toString() ?? '',
      enableCountryValidation: json['enableCountryValidation'] as bool? ?? false,
      allowedCountries: (json['allowedCountries'] as List<dynamic>?)?.cast<String>() ?? [],
      returnRefundPolicy: json['returnRefundPolicy']?.toString() ?? '',
      shippingPolicy: json['shippingPolicy']?.toString() ?? '',
