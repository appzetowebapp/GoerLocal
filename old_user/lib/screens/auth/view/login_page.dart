        ...
        builder: (context, constraints) {
          ...
          return Stack(
            children: [
              ...
              // Main Content (Always scrollable for responsiveness)
              Positioned.fill(
                top: MediaQuery.of(context).size.height * 0.32,
                child: SingleChildScrollView(
                  padding: EdgeInsets.only(
                    bottom: keyboardOpen ? 20.h : (MediaQuery.of(context).padding.bottom + 20.h),
                  ),
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if(SettingsData.instance.authentication?.googleLogin ?? false)...[
                    SizedBox(height: 15.h),
                    Opacity(
                      opacity: isVerifying ? 0.5 : 1.0,
                      child: AbsorbPointer(
                  ...
                  if (Platform.isIOS) ...[
                    if(SettingsData.instance.authentication?.appleLogin ?? false)...[
                      SizedBox(height: 16.h),
                      Opacity(
                        opacity: isVerifying ? 0.5 : 1.0,
                        child: AbsorbPointer(
    ...
    return BlocBuilder<UserVerificationBloc, UserVerificationState>(
      builder: (context, state) {
        ...
        if (_identifierController.text.trim().isEmpty) {
          ...
          helperText = state.error.isNotEmpty ? state.error : l10n.unableToVerifyUser;
