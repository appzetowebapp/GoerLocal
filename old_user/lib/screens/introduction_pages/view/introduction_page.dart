...
class IntroductionPageState extends State<IntroductionPage>
  ...
  List<OnboardingData> _getOnboardingData(BuildContext context) {
  ...
  Widget build(BuildContext context) {
    final l10n = AppLocalizations.of(context);
    final dataList = _getOnboardingData(context);
    
    if (l10n == null || dataList.isEmpty) {
        ...
        children: [
          ...
          PageView.builder(
            ...
            itemBuilder: (context, index) {
              return _buildOnboardingPage(dataList[index], dataList);
            },
          ),
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: List.generate(
                      dataList.length,
                      (index) => _buildIndicator(index, dataList.length),
                    ),
                  ),
  ...
  void _nextPage(List<OnboardingData> dataList) {
  ...
  Widget _buildOnboardingPage(OnboardingData data, List<OnboardingData> dataList) {
