  ...
  Future<Map<String, dynamic>> createOrder({
    ...
    try {
      ...
      if(paymentType.isNotEmpty && paymentType != 'wallet'){
        paymenttype = paymentType == 'cod' ? paymentType : 
            (paymentType.endsWith('Payment') ? paymentType : '${paymentType}Payment');
      ...
      if (e is dio.DioException && e.response != null) {
        ...
        String errorMessage = e.response?.data['message'] ?? e.toString();
