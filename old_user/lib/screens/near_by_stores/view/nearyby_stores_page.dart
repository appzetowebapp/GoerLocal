                ...
                builder: (context, state) {
                  ...
                  if (state is NearByStoreLoaded) {
                    ...
                    return ListView.builder(
                      ...
                      padding: EdgeInsets.only(top: 20, bottom: 100.h),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: const Color(0xFF231F3F).withValues(alpha: 0.8),
...
class ShimmerStoreCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Shimmer.fromColors(
      baseColor: const Color(0xFF231F3F),
      highlightColor: const Color(0xFF332F5F),
      child: Container(
