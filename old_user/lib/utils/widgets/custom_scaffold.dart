          ...
          return Container(
            decoration: const BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: [
                  Color.fromARGB(255, 215, 214, 255), // Deep Navy                   
                  Color.fromARGB(255, 254, 254, 255), // Deep Purple
                    ...
                    Directionality(
                      ...
                      child: AnimatedBuilder(
                        ...
                        builder: (context, child) {
                          ...
                          final bottomOffset = (_isCurrentlyConnected ? 0.0 : 45.0) + (widget.bottomNavigationBar == null ? bottomPadding : 0);
                          return Positioned(
  ...
  Widget _buildCartButton(BuildContext context, CartState cartBlocState) {
    return AnimatedButton(
      ...
      child: Container(
        ...
        height: isTablet(context) ? 40.w : 40.w,
      ...
      child: SizedBox(
        ...
        child: LiquidGlassLayer(
          ...
          child: LiquidGlass(
            ...
            child: SizedBox(
              width: _widthAnimation.value,
              height: isTablet(context) ? 42.w : 42.w,
              child: Stack(
